...
import { PaymentMethodUsageMetricReadModel, RemittanceQueryPort } from '../../domain/ports/remittance-query.port';

@Injectable()
export class AdminPaymentMethodUsageMetricsUseCase {
  constructor(
  ...
  async execute(input: {
    ...
    return this.remittanceQuery.getPaymentMethodUsageMetrics(input);
  }
}
